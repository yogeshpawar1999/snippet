...
const Header=()=> {
  return (
    <Navbar  expand="lg" className='header-nav'>
      <Container fluid>
        <Navbar.Brand href="#">
          <img src={Union} alt="microphone logo" width="30" height="30" className="d-inline-block align-top" />{' '}
        </Navbar.Brand>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          ...
          <Nav>
            <NavItem>
              <Nav.Link href="#"><button className="btn btn-outline-light" style={{color:"white", backgroundColor:"#1f0b78"}}>Register</button></Nav.Link>
              {/* <button className="btn btn-outline-light" style={{color:"white", backgroundColor:"#1f0b78"}}>Sign In</button>
              <button className="btn btn-outline-light" style={{color:"white", backgroundColor:"#1f0b78"}}>Sign In</button> */}

            </NavItem>
            <NavItem>
              <Nav.Link href="#"><button className="btn btn-outline-light" style={{color:"white", backgroundColor:"#1f0b78"}}>Sign In</button></Nav.Link>
            </NavItem>
          </Nav>
        </Navbar.Collapse>
      </Container>
